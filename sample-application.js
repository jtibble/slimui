...
var PromisesTemplate = '<h3 class=\"voice-brand\">Promises</h3><p>Promises can be used to trigger behavior after an asynchronous call has completed. For more information on how to use them, see <a href=\"https://docs.angularjs.org/api/ng/service/$q\">AngularJS \'$q\' Documentation</a>.</p><p>For binding to an asynchronous HTTP/AJAX call, please see the <a href=\"#/Examples/AJAX\">AJAX Documentation</a></p><hr><label>Promise Status: {{Model.text}}</label><br><br><button class=\"btn btn-primary\" ng-click=\"Actions.resolveDeferred()\">Click to Resolve Promise</button>';
...
var BowerTemplate = '<div class=\"row-fluid\"><h3 class=\"voice-brand\">Config Proxies</h3><p>We need previously installed Git and Node JS</p><h4 class=\"voice-brand\">Creating .bash_profile</h4><pre>\n1.-	Create file .bash_profile in your user folder, which is usually C:/Users/[SSO]/\n2.-	In .bash_profile, add the following:\n<h6># Enable npm & git behind the GE proxy with these ENV variables </h6>\n    export http_proxy=\"http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80\"\n    export HTTPS_PROXY=\"http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80\"\n    export https_proxy=\"http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80\"\n    export HTTP_PROXY=\"http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80\"\n    \n<h6># For GIT </h6>\n    export no_proxy=\"devcloud.sw.ge.com, openge.ge.com\" #Atlassian Stash and OpenGE\n		\n3.- Open up your .gitconfig file in C:/Users/[SSO]/.gitconfig and add the following:\n\n    [url \"ssh://\"]\n        insteadOf = git://\n     \n4.- Open up Git Bash from Start Menu -> Programs -> Git -> Git Bash       \n\n5.- Navigate to project folder\n\n6.- Add proxies to node package manager like this:\n\n    npm config set proxy http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80/ \n    npm config set https-proxy http://iss-americas-pitc-alpharettaz.proxy.corporate.ge.com:80/  \n	\n	</pre><h4 class=\"voice-brand\">Installing Bower</h4><pre>\n	\n1.- Opem Git Bash and type:\n\n    npm install -g bower\n\n2.- Run bower to fetch all UI dependencies:\n\n    bower install\n	\n</pre></div>';
var GITTemplate = '<div class=\"row-fluid\"><h3 class=\"voice-brand\">How configure Git</h3><p>We need previously installed Git (Git GUI and Git Bash)</p><h4 class=\"voice-brand\">Define the workspace</h4><p>Open the “Git Bash\"</p><pre>\n1.-	First, we need to go to local disk, we can use the next syntaxis :  \n		cd ../..   (click enter)\n2.-	Now, go to workspace:\n		cd GE_DATA_CLASSIFICATION/confidencial/workspace/  (click enter)\n3.-	Type your OpenGE email	\n		git clone ssh://nameaccount@ge.com/gitroot/ls2_0 ls20angular  (click enter)\n			(After this, you need type your OpenGE password)\n4.-	Then, in the screen will be appear a message dialog with two options:\n		Write yes (click enter) and wait for download\n5.-	When the download finish, type:\n		cd ls20angular/  (click enter)\n		and then	\n		git checkout \"master\" branch(click enter)\n		\n	<img src=\"sample_application/assets/img/img1.jpg\">		\n	</pre><p>Now, go to ls20angular folder: GE_DATA_CLASSIFICATION/confidencial/workspace/ls20angular and Press right click and select TortoiseGit:</p><pre>\n \n1.- First select Fetch \n\n<img src=\"sample_application/assets/img/img2.jpg\">\n\n2.- Press OK, after, type your password\n\n<img src=\"sample_application/assets/img/img3.jpg\">\n\n3.- When Fetch is finish, select Pull and repeat the last step.\n\n4.- Press right click and select TortoiseGit/Settings\n\n<img src=\"sample_application/assets/img/img4.jpg\">\n\n5.- Type your Name and your Email of GE.\n\n<img src=\"sample_application/assets/img/img5.jpg\">\n\n6.- Click in Edit local .git/config button and modify like this: (only substitude with your respective name and email)\n\n<img src=\"sample_application/assets/img/img6.jpg\">\n\n7.- Finally, press OK.\n	</pre></div>';
var NodeTemplate = '<div class=\"row-fluid\"><h3 class=\"voice-brand\">NodeJS Configuration</h3><p>We need previously installed NodeJS</p><h4 class=\"voice-brand\">Install the Test environment</h4><p>Open the Windows Console</p><pre>\n1.-	Go to ...ls-client\\src\\main\\javascript\\test\\nightwatch (click enter)\n2.-	Run to add proxy configuration:\n	npm config set proxy http://alpext11.proxy.corporate.ge.com:80/ (click enter)\n	npm config set https-proxy http://alpext11.proxy.corporate.ge.com:80/ (click enter)\n \n3.-	Run: \n	npm install (click enter)\n\n4.-	Download selenium-standalone (selenium-server-standalone-2.39.0.jar2)from libraries:\n	http://libraries.ge.com/foldersIndex.do?entity_id=29896711101&sid=101&SF=1#29896711101\n<h5>Note: Change the name selenium-server-standalone-2.39.0.jar2 to selenium-server-standalone-2.39.0.jar</h5>\n	\n5.-	Paste selenium-standalone driver and put it in:\n...ls-client\\src\\main\\javascript\\test\\nightwatch\\selenium-driver\\ (click enter)\n\n6.- Open Firefox (default browser) and paste the url:\n	http://localhost:8080/client/javascript/app/brands/ge/#/DMC\n\n7.-	In the console go to ...ls-client\\src\\main\\javascript\\test\\nightwatch (click enter)\n	and then run:\n 		node nightwatch.js -c nightwatch-settings.json (click enter)\n\n	</pre><p>Configuration for Chrome Browser:</p><pre>\n \n1.-	Download chrome driver from http://libraries.ge.com/foldersIndex.do?entity_id=29896711101&sid=101&SF=1#29896711101\nChange the name chromedriver.exe2 to chromedriver.exe\n\n2.-	Paste selenium-server-standalone-2.39.0.jar and chromedriver.exe into \n…\\ls-client\\src\\main\\javascript\\test\\nightwatch\\drivers\n\n3.-	Open Chrome and paste the url:\nhttp://localhost:8080/client/javascript/app/brands/ge/#/DMC\n\n4.-	in the console go to ...ls-client\\src\\main\\javascript\\test\\nightwatch \n5.-	run:\n node nightwatch.js -c nightwatch-settings.json\n\n	</pre></div>';
var SetupMenuTemplate = '<h3 class=\"voice-brand\">Menu</h3><ul><li><a href=\"#/Setup/Node\">How to set up NodeJS</a></li><li><a href=\"#/Setup/GIT\">How to set up Git</a></li><li><a href=\"#/Setup/Bower\">Install Bower and Config Proxies</a></li></ul>';
